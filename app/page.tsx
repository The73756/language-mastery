...
export default function Home() {
  return (
    <div className="flex flex-col gap-14 md:gap-[80px] container pt-14 xl:pt-[100px] pb-20">
      ...
      <TextBlock
        title="Как достичь лучшего результата?"
        subtitle="Вот наши рекомендации"
        text='В "LanguageMastery" мы считаем, что максимальные результаты в изучении языков достижимы через постоянную практику, использование мультимедийных материалов, общение с носителями языка, участие в нашем онлайн-сообществе, целеустремленность и поддержание мотивации. /n Выбрав "LanguageMastery", вы выбираете инновационный подход к языковому обучению, стимулирующую образовательную среду и эффективные методики.'
        direction="right"
        buttonText=""
        buttonLink=""
        imageUrl="/images/text-2.png"
      />
    </div>
  )
}
